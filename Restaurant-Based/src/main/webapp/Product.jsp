...
<div class="row">
  <div class="column">
    ...
    <input type="checkbox" id="FryspieceBiryani" name="FryspieceBiryani" value="FryspieceBiryani">
  ...
  <div class="column">
    ...
    <label for="upass" id="ps">Quantity:</label>
    <input type="text" name="Qulity" placeholder="0" id="Qulity"><br/>
     <input type="checkbox" id="MuttonPotBiryani" name="MuttonPotBiryani" value="MuttonPotBiryani">
   ...
   <div class="column">
    ...
    <label for="upass" id="ps">Quantity:</label>
    <input type="text" name="Qulity" placeholder="0" id="Qulity"><br/>
            <input type="checkbox" id="DumBiryani" name="DumBiryani" value="DumBiryani">
    ...
    <label for="upass" id="ps">Quantity:</label>
    <input type="text" name="Qulity" placeholder="0" id="Qulity"><br/>
            <input type="checkbox" id="MuttonDumBiryani" name="MuttonDumBiryani" value="MuttonDumBiryani">
  ...
    <div class="column">
    ...
    <label for="upass" id="ps">Quantity:</label>
    <input type="text" name="Qulity" placeholder="0" id="Qulity"><br/>
                <input type="checkbox" id="BonesBiryani" name="BonesBiryani" value="BonesBiryani">
  ...
    <div class="column">
    ...
    <label for="upass" id="ps">Quantity:</label>
    <input type="text" name="Qulity" placeholder="0" id="Qulity"><br/>
     <input type="checkbox" id="lollipopBiryani" name="lollipopBiryani" value="lollipopBiryani">
 ...
 <h3 style="font-style: oblique;"><b>Starters :</b></h3>
    ...
    <label for="upass" id="ps">Quantity:</label>
    <input type="text" name="Qulity" placeholder="0" id="Qulity"><br/>
         <input type="checkbox" id="Chicken-Majestic" name="Chicken-Majestic" value="Chicken-Majestic">
  ...
  <div class="column">
   ...
   <div class="column">
    ...
    <label for="upass" id="ps">Quantity:</label>
    <input type="text" name="Qulity" placeholder="0" id="Qulity"><br/>
                 <input type="checkbox" id="lollipop" name="lollipop" value="lollipop">
